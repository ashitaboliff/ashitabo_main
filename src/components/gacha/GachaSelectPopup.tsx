...
import GachaPickupPopup, { GachaPickupPopupRef } from '@/components/gacha/GachaPickupPopup'
...
const ImageCarousel = () => {
  ...
  return (
    <div
      className="relative flex items-center justify-center w-full h-[600px] overflow-hidden select-none"
    >
      <button
      ...
      <div className="relative flex items-center justify-center w-full">
        ...
        <div
          className="relative z-20 transform transition-transform"
        >
          <Image
